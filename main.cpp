...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Artiqox-seeder\n"
...
static const string mainnet_seeds[] = {"seed.artiqox.com", ""}; //TODO: We don't have any other seeds yet. Add them in next revision.
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){ 
    db.Add(CService("85.214.211.106", GetDefaultPort()), true);
  }
  do {
